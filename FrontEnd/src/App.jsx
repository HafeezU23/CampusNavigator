...
const buildings = ["Admin Block","Room 1","Room 2","Room 3", "Room 4","Room 5", "Room 6","Room 7","Room 8","Room 9", "Room 10","Room 11","Room 12","Room 13","Room 14", "Room 15", "Room 16", "Room 17", "Room 18","Server Room", "Library", "Cafeteria", "Computer Labs", "Auditorium", "Washrooms"];
...
const buildingPositions = {
  ...
  "Room 17": { x: 400, y: 300 },
  "Room 18": { x: 500, y: 300 },
  "Server Room": { x: 600, y: 300 },
  "Library": { x: 600, y: 200 },
  "Cafeteria": { x: 700, y: 200 },
  "Computer Labs": { x: 800, y: 200 },
  "Auditorium": { x: 900, y: 200 },
  "Washrooms": { x: 700, y: 300 },
};
...
export default function App() {
  ...
  useEffect(() => {
    const initialNodes = buildings.map(name => ({
      id: name,
      data: { label: name },
      ...
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg">
        ...
        {result && (
          <div className="mt-6 text-center">
            ...
            <p className="text-md">Distance: {result.distance} meters</p>
          </div>
        )}
